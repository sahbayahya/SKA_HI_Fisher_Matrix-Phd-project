...
(z1_new, Err_lnda1_new, Err_lnH1_new,R1_new,B1_new) = loadtxt('FotranCodes/output_Fisher_bao_BOSS_S5000_bias.txt', unpack=True)#;z1 = z1[0:13] ;  Err_lnda1 = Err_lnda1[0:13]
...
p4_new, = ax.plot(z1_new,  Err_lnda1_new , color = 'black',linewidth=1.5, linestyle="-", label=r"${\rm BOSS}$")
...
l2 = plt.legend([p4, p4_new],[r"${\rm Euclid} \ {\rm }$", r"${\rm BOSS}$"], loc=4, frameon = False)
