...
xo, yo = -1, 0  # Best fit w0, Ok

#=============================================================================
# The Values of w_0 and Ok for a ll the sensitivites, 7.3 mJy For the SKA
#=============================================================================
...
print "==========================================="
print 
fom_1mJy = FoM(dx_150, dy_150, dxdy_150, Delta_x1) ; print 'FoM  Coe DETF + SKA (150uJy) = ', fom_1mJy
fom_5 = FoM(dx_5, dy_5, dxdy_5, Delta_x1);           print 'FoM  Coe DETF + SKA (7.3uJy) = ', fom_5
...
plot(xo, yo, color = 'k', linestyle= '-',linewidth=1.5)
savefig("plots/output_ellipse_w0_wa.pdf")
