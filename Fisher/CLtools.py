...
# ~/lp/
# ~/glens/h0limits/cosmo/8/
# ~/glens/h0limits/cosmo/3/
# ~/glens/h0limits/cosmo/2/
# CLtools.py
#
# ~/cosmo/DETFast/plots/flat/plotell.py
# ~/cosmo/DETFast/plots/
# ~/glens/h0limits/cosmo/covariance.py
...
axhor = string.split('h w w0 wa OQ OL Ode Om Ok')
...
def plotellsp(xo, yo, dx, dy, p, colors=blues, alpha=1, zorder=1, lw=1, fill=0, nD=2):
